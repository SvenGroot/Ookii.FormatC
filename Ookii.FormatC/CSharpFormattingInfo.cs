                ...
                if( _patterns == null )
                {
                    _patterns = new List<CodeElement>() { 
                        ...
                        new CodeElement("keyword", new string[] { "abstract", "as", "base", "bool", "break", "byte", "case", "catch", "char",
                            ...
                            "explicit", "extern", "false", "finally", "fixed", "float", "for", "foreach", "goto", "if", "implicit", "in", "in",
                            "int", "interface", "internal", "is", "lock", "long", "namespace", "new", "null", "object", "operator", "out", "out",
                            ...
                            "add", "dynamic", "from", "get", "global", "group", "into", "join", "let", "orderby", "partial", "remove", "select",
